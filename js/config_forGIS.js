	...
	var globalParameters = {
			...
			data : {
				...
				epiDataset : {
					...
					source : "data/ebola_export_test.csv",
			...
			analysis : {
				...
				rates : {
	                ...
	                analysis_2 : {
	                    config : {
	                        name            :   "Cumulative cases per village",
	                        abbreviation    :   "AR",
	                        fieldRate       :   "AR_x10000",
				...
				geoSources : {
					polygons : {
		                ...
		                source  : "data/ebola_aires.geojson",
	            ...
	            casesStyle : {
	                ...
	                titleForLegend : "Cases (by villages)",
			...
			context : [
				{
	                ...
	                name    : "Zones de Sante",
	                // source (STRING) - Source of the layer's data.
	                source  : "data/ebola_zones.geojson",
	                // format (STRING) - Set the format of the dataset.
	                format  : "GeoJSON",
		    ...
		    layout : {
		        ...
		        appTitle : "DRC - 2018 Ebola outbreak",
		        ...
		        analysisDescription : "<i>No need for explanations. 1.</i>",
		        ...
		        dimensionDescription : "<i>Choose the week's data you want to be displayed on the map by moving this slider. It starts at week 14 as no case has been reported before that week. Note that we are Week 22 right now, so cases will not appear after this date.</i>",
